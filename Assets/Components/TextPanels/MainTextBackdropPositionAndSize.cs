...
public class MainTextBackdropPositionAndSize : MonoBehaviour
{
    ...
    private void UpdateRect()
    {
        ...
        _RectTransform.anchorMin = new Vector2(0, -0.1f); // exceed to avoid rounding errors and not covering all street
